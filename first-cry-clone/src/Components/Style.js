...
export const Screen = styled.div`
  ...
  top: 0px;
  background: #010107;
  background: -webkit-linear-gradient(top left, #010107, #1b21f0);
  background: -moz-linear-gradient(top left, #010107, #1b21f0);
  background: linear-gradient(to bottom right, #010107, #1b21f0);
...
export const Wrapper = styled.div`
  ...
  top: 55px;
  background: #ffffff;
  box-shadow: 0px 3.30191px 29.7172px rgba(0, 0, 0, 0.12);
  border-radius: 8px;
  padding: 20px;
...
export const Header = styled.div`
  ...
  bottom: -20px;
  background: #ffffff;
  border-bottom: 0.825478px solid #d4d4d4;
  border-radius: 6.60382px 6.60382px 0px 0px;
  flex-direction: row;
...
export const Text = styled.div`
  ${({ size }) =>
    ...
    @media (max-width: 1400px) {
      ...
      line-height: ${
        theme[themeName].font.lineHeight[
          size === "xxxl" ? "xxl" : ["md", "rg"].includes(size) ? "sm" : size
        ]
      };
    }
  `}
  color: ${(props) =>
    props.color
      ? theme[themeName].color[props.color]
      : theme[themeName].color.color1};
  font-weight: ${(props) =>
    props.fw
      ? theme[themeName].font.fontWeight[props.fw]
      : theme[themeName].font.fontWeight.regular};
`;
...
export const Heading = styled.p`
  ${({ size }) =>
    ...
    @media (max-width: 1400px) {
      font-size: ${
        theme[themeName].font.fontSize[
          size === "xxxl" ? "xxl" : size === "xxl" ? "xl" : size
        ]
      };
      line-height: ${
        theme[themeName].font.lineHeight[
  ...
  color: ${(props) =>
    props.color
      ? theme[themeName].color[props.color]
      : theme[themeName].color.color8};
  font-weight: ${(props) =>
    props.fw
      ? theme[themeName].font.fontWeight[props.fw]
      : theme[themeName].font.fontWeight.medium};
`;
...
export const IconInactive = styled.i`
  ...
  border: 1px solid
    ${({ color }) =>
      color ? theme[themeName].color[color] : theme[themeName].color.color3};
  &:after {
    content: "";
    width: 1px;
    height: 100%;
